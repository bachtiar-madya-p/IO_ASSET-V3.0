...
function init_sidebar() {
    ...
    var setContentHeight = function() {
        ...
        var bodyHeight = $BODY.outerHeight(), footerHeight = $BODY.hasClass('footer_fixed') ? -10 : $FOOTER.height(), leftColHeight = $LEFT_COL
                .eq(1).height()
                + $SIDEBAR_FOOTER.height(), contentHeight = bodyHeight < leftColHeight ? leftColHeight : bodyHeight;
                ...
                function() {
                    $('.collapse-link')
                            .on(
                                    'click',
                                    function() {
                                        var $BOX_PANEL = $(this).closest('.x_panel'), $ICON = $(this).find('i'), $BOX_CONTENT = $BOX_PANEL
                                                .find('.x_content');
...
function init_daterangepicker() {
    ...
    $('#reservation').daterangepicker(
            ...
            function(start, end, label) {
                ...
                console.log($('#reservation').data('daterangepicker').startDate, $('#reservation').data(
